...
<div bind:this={element} style="height: calc(100%); font-size: 15pt;" />
...
<style unscoped>
  ...
  :global(.cm-s-default .cm-variable, .cm-s-default .cm-punctuation, .cm-s-default .cm-property, .cm-s-default .cm-operator) {
  }
  ...
  :global(.CodeMirror-line::-moz-selection, .CodeMirror-line > span::-moz-selection, .CodeMirror-line
      > span
      > span::-moz-selection) {
    background: #d7d4f0;
  }
